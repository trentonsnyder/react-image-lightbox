!function(root, factory) {
    ...
    function(module, exports) {
        ...
        exports.SOURCE_POINTER = 3, exports.MIN_SWIPE_DISTANCE = 200, exports.ROTATION = 90;
    }, /* 2 */
    /***/
    function(module, exports, __webpack_require__) {
        "use strict";
        ...
        var ReactImageLightbox = function(_Component) {
            function ReactImageLightbox(props) {
                ...
                _this.requestMovePrev = _this.requestMovePrev.bind(_this), _this.handleRotateLeftClick = _this.handleRotateLeftClick.bind(_this), 
                _this.handleRotateRightClick = _this.handleRotateRightClick.bind(_this), _this;
            }
            return _inherits(ReactImageLightbox, _Component), _createClass(ReactImageLightbox, [ {
                ...
                key: "handleRotateLeftClick",
                value: function() {
                    this.changeRotation(this.state.rotation - _constant.ROTATION);
                }
            }, {
                key: "handleRotateRightClick",
                value: function() {
                    this.changeRotation(this.state.rotation + _constant.ROTATION);
                }
            }, {
                ...
                key: "render",
                value: function() {
                    var _this14 = this, _props = this.props, animationDisabled = _props.animationDisabled, animationDuration = _props.animationDuration, clickOutsideToClose = _props.clickOutsideToClose, discourageDownloads = _props.discourageDownloads, enableZoom = _props.enableZoom, enableRotation = _props.enableRotation, imageTitle = _props.imageTitle, nextSrc = _props.nextSrc, prevSrc = _props.prevSrc, toolbarButtons = _props.toolbarButtons, reactModalStyle = _props.reactModalStyle, _state = this.state, zoomLevel = _state.zoomLevel, offsetX = _state.offsetX, offsetY = _state.offsetY, isClosing = _state.isClosing, rotation = _state.rotation, boxSize = this.getLightboxRect(), transitionStyle = {};
                    ...
                    var images = [], addImage = function(srcType, imageClass) {
                        ...
                        if (_this14.props[srcType]) {
                            ...
                            images.push(_react2.default.createElement("div", {
                                ...
                                var rotateStyle = void 0;
                                rotateStyle = "image-current ril-image-current" === imageClass ? _extends({}, imageStyle, {
                    ...
                    var noop = function() {}, zoomInButtonClasses = [ styles.toolbarItemChild, styles.builtinButton, styles.zoomInButton ], zoomOutButtonClasses = [ styles.toolbarItemChild, styles.builtinButton, styles.zoomOutButton ], zoomInButtonHandler = this.handleZoomInButtonClick, zoomOutButtonHandler = this.handleZoomOutButtonClick, rotateLeftHandler = this.handleRotateLeftClick, rotateRightHandler = this.handleRotateRightClick;
                    ...
                    }) : "", enableRotation && _react2.default.createElement("li", {
                        className: "ril-toolbar__item " + styles.toolbarItem
                    ...
                    }, "Left")), enableRotation && _react2.default.createElement("li", {
                        className: "ril-toolbar__item " + styles.toolbarItem
                    }, _react2.default.createElement("button", {
                        // Lightbox zoom in button
                        type: "button",
                    ...
                    }, "right")), enableZoom && _react2.default.createElement("li", {
                        className: "ril-toolbar__item " + styles.toolbarItem
                    }, _react2.default.createElement("button", {
                        // Lightbox zoom in button
                        type: "button",
        ...
        ReactImageLightbox.propTypes = {
            ...
            enableRotation: _react.PropTypes.bool
